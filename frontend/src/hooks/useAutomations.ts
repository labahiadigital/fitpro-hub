          ...
          items: [
            {
              ...
              description:
                "Envía email de bienvenida y asigna formulario PAR-Q cuando se crea un cliente",
            ...
            },
            {
              ...
              description:
                "Envía recordatorio por email 24 horas antes de la sesión",
            ...
            },
            {
              ...
              description:
                "Envía mensaje cuando un cliente no tiene actividad en 14 días",
            ...
            },
            {
              ...
              description:
                "Notifica 7 días antes del vencimiento de la suscripción",
              ...
              actions: [
                {
                  type: "send_email",
                  config: { template: "renewal_reminder" },
                },
                {
                  type: "send_in_app",
                  config: { message: "Tu suscripción vence pronto" },
                },
              ],
              is_active: true,
              stats: {
