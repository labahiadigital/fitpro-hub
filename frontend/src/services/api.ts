...
export const clientsApi = {
  ...
  createTag: (data: { name: string; color: string }) => api.post('/clients/tags', data),
...
export const workoutsApi = {
  ...
  updateExercise: (id: string, data: object) => api.put(`/workouts/exercises/${id}`, data),
  ...
  updateProgram: (id: string, data: object) => api.put(`/workouts/programs/${id}`, data),
...
export const nutritionApi = {
  ...
  updatePlan: (id: string, data: object) => api.put(`/nutrition/plans/${id}`, data),
...
export const formsApi = {
  ...
  submit: (formId: string, data: object) => api.post(`/forms/${formId}/submit`, data),
...
export const messagesApi = {
  ...
  createConversation: (data: object) => api.post('/messages/conversations', data),
...
export const paymentsApi = {
  ...
  // Subscriptions
  subscriptions: (params?: object) => api.get('/payments/subscriptions', { params }),
  getSubscription: (id: string) => api.get(`/payments/subscriptions/${id}`),
  createSubscription: (data: object) => api.post('/payments/subscriptions', data),
...
export const reportsApi = {
  ...
  revenueChart: (months: number) => api.get('/reports/revenue', { params: { months } }),
  clientsChart: (months: number) => api.get('/reports/clients', { params: { months } }),
  overview: (period: string) => api.get('/reports/overview', { params: { period } }),
...
export const settingsApi = {
  ...
  updateNotifications: (data: object) => api.put('/settings/notifications', data),
}
