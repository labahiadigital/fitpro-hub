...
Catálogos globales (lista cerrada de alergenos UE-14, intolerancias, etc.).
No exponen datos de usuarios pero los protegemos de igual forma para evitar
scraping anónimo: solo se sirven a usuarios autenticados de la plataforma.
"""
